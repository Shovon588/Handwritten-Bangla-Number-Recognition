...
def predictInput(imgPath,resize=32):
...
xTrainB,yTrainB=getData(paths_train_b,label_train_b,resize=resizeDim)
...
xTrainAll=np.concatenate((xTrainB),axis=0)
yTrainAll=np.concatenate((yTrainB),axis=0)
...
xTrainAll=xTrainAll.reshape(xTrainAll.shape[0],16,32,1)
...
#Model Training
pathModel='model_filter_upper.h5'
